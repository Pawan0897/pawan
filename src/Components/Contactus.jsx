          ...
          <div className="about bg-color ">
            <div className="row px-5 py-3">
              <div className="col-md-12 col-lg-6 col-sm-12">
                <div className="about-detail d-flex d-non">
                  ...
                  <div className="ms-4 about-icon">
                    ...
                    <p>
                      I am a{" "}
                      <span className="bgcolortext">Full Stack Developer</span>
                    </p>

                    <ul className="example-2 mt-5">
                      <li className="icon-content ">
                        <Link
                          to="https://www.linkedin.com/in/pawan-kumar-05533b242/"
                          aria-label="LinkedIn"
              ...
              <div className="col-md-12 col-lg-6 col-sm-12 border-start">
                <div className="about-me ms-5 pt-3">
                  <div className="row">
                    <div className="col-md-6">
                      <div className="about-det">
                        <span className="mt-3 bgcolortext">email</span>
                        <p className="mt-3"> pawankumarwebdev@gmail.com</p>
                        <span className="mt-3 bgcolortext">Location</span>
                        <p className="mt-3">Amritsar | Tarn-Taran | 143409</p>
                      </div>
                    </div>
                    <div className="col-md-6 ps-5 p2">
                      <div className="about-det">
                        <span className="mt-3 bgcolortext">phone</span>
                        <p className="mt-3">+91 9781222386</p>
                      </div>
                    </div>
                  </div>
                </div>
