            ...
            <div className="row">
              ...
              <div className="col-md-12  mt-5">
                ...
                <h2 className="font-styleX text-center " data-aos="fade-up">
                  L<strong className="bgcolortext">i</strong>ve P
                  <strong className="bgcolortext">r</strong>oj
                  <strong className="bgcolortext">ec</strong>t
                </h2>
                {/* ************** Light */}
                <div className="light mt-3">
                  <div className=" text-center light-line"></div>
                </div>
              </div>
            </div>
            {/* ********************* */}
                    ...
                    <div className="col-md-6 col-lg-4 mt-4">
                      ...
                      <div className="project-card ">
                        <CardContainer className="inter-var" key={item?.id}>
                          <CardBody className=" relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1]   w-auto sm:w-[30rem] h-auto rounded-xl p-2   ">
                            {/* <CardItem
          translateZ="50"
